...
#######################
# GPIO-EPH
#  First 9 pairs are present on all parts - These are driven by Epiphany
#######################
set_property IOSTANDARD LVCMOS25 [get_ports {GPIO_EPH_tri_io*}]
set_property PACKAGE_PIN T16 [get_ports {GPIO_EPH_tri_io[0]}] 
set_property PACKAGE_PIN U17 [get_ports {GPIO_EPH_tri_io[1]}]
set_property PACKAGE_PIN V16 [get_ports {GPIO_EPH_tri_io[2]}]
set_property PACKAGE_PIN W16 [get_ports {GPIO_EPH_tri_io[3]}]
set_property PACKAGE_PIN P15 [get_ports {GPIO_EPH_tri_io[4]}]
set_property PACKAGE_PIN P16 [get_ports {GPIO_EPH_tri_io[5]}]
set_property PACKAGE_PIN U18 [get_ports {GPIO_EPH_tri_io[6]}]
set_property PACKAGE_PIN U19 [get_ports {GPIO_EPH_tri_io[7]}]
set_property PACKAGE_PIN P14 [get_ports {GPIO_EPH_tri_io[8]}]
set_property PACKAGE_PIN R14 [get_ports {GPIO_EPH_tri_io[9]}]
set_property PACKAGE_PIN T14 [get_ports {GPIO_EPH_tri_io[10]}]
set_property PACKAGE_PIN T15 [get_ports {GPIO_EPH_tri_io[11]}]
set_property PACKAGE_PIN U14 [get_ports {GPIO_EPH_tri_io[12]}]
set_property PACKAGE_PIN U15 [get_ports {GPIO_EPH_tri_io[13]}]
set_property PACKAGE_PIN W14 [get_ports {GPIO_EPH_tri_io[14]}]
set_property PACKAGE_PIN Y14 [get_ports {GPIO_EPH_tri_io[15]}]
set_property PACKAGE_PIN U13 [get_ports {GPIO_EPH_tri_io[16]}]
set_property PACKAGE_PIN V13 [get_ports {GPIO_EPH_tri_io[17]}]

#######################
# GPIO-PS7
#  Last 3 pairs are present on all parts - These are driven by PS7 EMIO
#######################
set_property IOSTANDARD LVCMOS25 [get_ports {GPIO_PS7_tri_io*}]
set_property PACKAGE_PIN V12 [get_ports {GPIO_PS7_tri_io[0]}]
set_property PACKAGE_PIN W13 [get_ports {GPIO_PS7_tri_io[1]}]
set_property PACKAGE_PIN T12 [get_ports {GPIO_PS7_tri_io[2]}]
set_property PACKAGE_PIN U12 [get_ports {GPIO_PS7_tri_io[3]}]
set_property PACKAGE_PIN T11 [get_ports {GPIO_PS7_tri_io[4]}]
set_property PACKAGE_PIN T10 [get_ports {GPIO_PS7_tri_io[5]}]
